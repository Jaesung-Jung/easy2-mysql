namespace ScintillaNet
{
	partial class GoToDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblCurrentLine.Size = new System.Drawing.Size(73, 13);
			this.lblCurrentLine.TabIndex = 0;
			this.lblCurrentLine.Text = "현재 줄 번호";
			// 
			// txtCurrentLine
			// 
			...
			this.lblMaxLine.Size = new System.Drawing.Size(73, 13);
			this.lblMaxLine.TabIndex = 2;
			this.lblMaxLine.Text = "최대 줄 번호";
			// 
			// txtGotoLine
			// 
			...
			this.lblGotoLine.Size = new System.Drawing.Size(46, 13);
			this.lblGotoLine.TabIndex = 4;
			this.lblGotoLine.Text = "줄 번호";
			// 
			// btnOK
			// 
