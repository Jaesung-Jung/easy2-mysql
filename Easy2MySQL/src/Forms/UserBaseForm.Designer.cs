namespace Easy2
{
	partial class UserBaseForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_usernameText = new TextBoxEx();
			this.m_hostLabel = new DevComponents.DotNetBar.LabelX();
			this.m_hostText = new TextBoxEx();
			this.m_PasswordLabel = new DevComponents.DotNetBar.LabelX();
			this.m_PasswordText1 = new TextBoxEx();
			this.m_retypePasswordLabel = new DevComponents.DotNetBar.LabelX();
			this.m_PasswordText2 = new TextBoxEx();
			this.m_allVersionGroupBox = new System.Windows.Forms.GroupBox();
			this.m_grant = new CheckBoxEx();
			this.m_alter = new CheckBoxEx();
			this.m_index = new CheckBoxEx();
			this.m_reference = new CheckBoxEx();
			this.m_file = new CheckBoxEx();
			this.m_process = new CheckBoxEx();
			this.m_shutdown = new CheckBoxEx();
			this.m_reload = new CheckBoxEx();
			this.m_drop = new CheckBoxEx();
			this.m_create = new CheckBoxEx();
			this.m_delete = new CheckBoxEx();
			this.m_update = new CheckBoxEx();
			this.m_insert = new CheckBoxEx();
			this.m_select = new CheckBoxEx();
			this.m_402VersionGroupBox = new System.Windows.Forms.GroupBox();
			this.m_create_tmp_tables = new CheckBoxEx();
			this.m_lock_tables = new CheckBoxEx();
			this.m_super = new CheckBoxEx();
			this.m_repl_client = new CheckBoxEx();
			this.m_show_db = new CheckBoxEx();
			this.m_repl_slave = new CheckBoxEx();
			this.m_execute = new CheckBoxEx();
			this.m_500VersionGroupBox = new System.Windows.Forms.GroupBox();
			this.m_create_user = new CheckBoxEx();
			this.m_alter_routine = new CheckBoxEx();
			this.m_show_view = new CheckBoxEx();
			this.m_create_routine = new CheckBoxEx();
			this.m_create_view = new CheckBoxEx();
			this.m_510VersionGroupBox = new System.Windows.Forms.GroupBox();
			this.m_event = new CheckBoxEx();
			this.m_trigger = new CheckBoxEx();
		...
		protected TextBoxEx m_usernameText;
		protected DevComponents.DotNetBar.LabelX m_hostLabel;
		protected TextBoxEx m_PasswordText1;
		protected TextBoxEx m_hostText;
		protected DevComponents.DotNetBar.LabelX m_PasswordLabel;
		protected DevComponents.DotNetBar.LabelX m_retypePasswordLabel;
		protected TextBoxEx m_PasswordText2;
		protected System.Windows.Forms.GroupBox m_allVersionGroupBox;
		protected CheckBoxEx m_grant;
		protected CheckBoxEx m_trigger;
		protected CheckBoxEx m_alter;
		protected CheckBoxEx m_index;
		protected CheckBoxEx m_reference;
		protected CheckBoxEx m_file;
		protected CheckBoxEx m_process;
		protected CheckBoxEx m_shutdown;
		protected CheckBoxEx m_reload;
		protected CheckBoxEx m_drop;
		protected CheckBoxEx m_create;
		protected CheckBoxEx m_delete;
		protected CheckBoxEx m_update;
		protected CheckBoxEx m_insert;
		protected CheckBoxEx m_select;
		protected System.Windows.Forms.GroupBox m_402VersionGroupBox;
		protected CheckBoxEx m_create_tmp_tables;
		protected CheckBoxEx m_lock_tables;
		protected CheckBoxEx m_super;
		protected CheckBoxEx m_repl_client;
		protected CheckBoxEx m_show_db;
		protected CheckBoxEx m_repl_slave;
		protected CheckBoxEx m_execute;
		protected System.Windows.Forms.GroupBox m_500VersionGroupBox;
		protected CheckBoxEx m_create_user;
		protected CheckBoxEx m_alter_routine;
		protected CheckBoxEx m_show_view;
		protected CheckBoxEx m_create_routine;
		protected CheckBoxEx m_create_view;
		protected System.Windows.Forms.GroupBox m_510VersionGroupBox;
		protected CheckBoxEx m_event;
